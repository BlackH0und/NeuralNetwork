...
public class Brain implements Serializable {
    ...
    private final NeuralLayer layer1, layer3;
    ...
    public Brain(NeuralLayer layer1, NeuralLayer layer3, NeuralLayer... midLayers) {
        this.layer1 = layer1;
    ...
    public void think(double[][] inputs) {
        ...
        outputLayer3 = Calculations.apply(Calculations.matrixMultiply(outputLayer1, layer3.weights), layer3.activationFunction);
    }
    ...
    public void train(double[][] inputs, double[][] outputs, int numberOfTrainingIterations) {
        for (int i = 0; i < numberOfTrainingIterations; ++i) {
            ...
            double[][] errorLayer1 = Calculations.matrixMultiply(deltaLayer3, Calculations.matrixTranspose(layer3.weights));
            ...
            double[][] adjustmentLayer3 = Calculations.matrixMultiply(Calculations.matrixTranspose(outputLayer1), deltaLayer3);
